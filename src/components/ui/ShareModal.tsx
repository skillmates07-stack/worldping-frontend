...
/* 
  Make sure your tailwind/global css includes:
  .modal-overlay {
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="modal-content bg-gray-900 rounded-2xl shadow-xl p-6 w-full max-w-md mx-4 flex flex-col gap-4 border-2 border-gray-800"
